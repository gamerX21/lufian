...
$clientC=new clientC();
$client=$clientC->recupererClient($_GET['num']);
foreach($client as $row){}
?>
<head>
<title>Lufian-admin panel</title>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username">lufian admin</span>
                <b class="caret"></b>
            </a>
...
if (isset($_POST["modifier"])){
		...
		$clientF= new client($_POST['email'],"","",$_POST['nom'],$_POST['prenom'],"","",$_POST['adresse'],"",0,0,0,0,"");
		

	
		$clientC->modifierClient($clientF,$_POST['num']);
